# This is a hacked version of fitting.py from sncosmo to allow use of model
# covariance. Should be removed once sncosmo can do this on its own
# Kept in a separate file because of the imports from __future__
...
from sncosmo.photdata import standardize_data, normalize_data
